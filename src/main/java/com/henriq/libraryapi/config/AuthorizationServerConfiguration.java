...
import com.henriq.libraryapi.security.CustomAuthentication;
...
public class AuthorizationServerConfiguration {
    ...
    public OAuth2TokenCustomizer<JwtEncodingContext> tokenCustomizer()  {
        return context -> {
            if(context.getPrincipal() instanceof CustomAuthentication auth) {
                ...
                if(OAuth2TokenType.ACCESS_TOKEN.equals(tokenType)) {
                    ...
                    context.getClaims()
                            ...
                            .claim("email", auth.getUser().getEmail())
                            .build();
                }
            }
        };
